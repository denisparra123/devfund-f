...
{
  protected static final String DIRECTORY = "./homework3-files/";
  ...
  public void testTextOneSentence() {
    File localFile = new File("./homework3-files/test1.txt");
    if (!localFile.exists()) {
    ...
    try {
      List localList = Analyzer.readFile("./homework3-files/test1.txt");
      if (localList == null)
  ...
  public void testScoreOneSentence() {
    File localFile = new File("./homework3-files/test2.txt");
    if (!localFile.exists()) {
    ...
    try
    {
      List localList = Analyzer.readFile("./homework3-files/test2.txt");
      if (localList == null)
        Assert.fail("readFile returns null when processing file with one sentence");
      if (localList.isEmpty()) {
        Assert.fail("readFile returns empty List when processing file with one sentence");
  ...
  public void testMultipleSentencesPositiveScores() {
    File localFile = new File("./homework3-files/test3.txt");
    if (!localFile.exists()) {
    ...
    try
    {
      List localList = Analyzer.readFile("./homework3-files/test3.txt");
      if (localList == null)
  ...
  public void testMultipleSentencesNegativeScores() {
    File localFile = new File("./homework3-files/test4.txt");
    if (!localFile.exists()) {
    ...
    try
    {
      List localList = Analyzer.readFile("./homework3-files/test4.txt");
      if (localList == null)
        Assert.fail("readFile returns null when processing file with multiple sentences");
      if (localList.isEmpty()) {
        Assert.fail("readFile returns empty List when processing file with multiple sentences");
  ...
  public void testIgnoreInvalidSentenceWithNoScore() {
    File localFile = new File("./homework3-files/test5.txt");
    if (!localFile.exists()) {
    ...
    try
    {
      List localList = Analyzer.readFile("./homework3-files/test5.txt");
      if (localList == null)
  ...
  public void testIgnoreInvalidSentenceWithNoText() {
    File localFile = new File("./homework3-files/test6.txt");
    if (!localFile.exists()) {
    ...
    try
    {
      List localList = Analyzer.readFile("./homework3-files/test6.txt");
      if (localList == null)
  ...
  public void testIgnoreInvalidSentenceWithScoreOutsideRange() {
    File localFile = new File("./homework3-files/test7.txt");
    if (!localFile.exists()) {
    ...
    try
    {
      List localList = Analyzer.readFile("./homework3-files/test7.txt");
      if (localList == null)
  ...
  public void testIgnoreInvalidSentenceWithScoreNotAnInteger() {
    File localFile = new File("./homework3-files/test8.txt");
    if (!localFile.exists()) {
    ...
    try
    {
      List localList = Analyzer.readFile("./homework3-files/test8.txt");
      if (localList == null)
