...
/**
 * Test for {@link Scramblies}.
 */
public class ScrambliesTest {

    /**
     * Simplifies assert equals.
     *
     * @param actual   actual result.
     * @param expected expected result.
     */
    private static void testing(final boolean actual, final boolean expected) {
        assertEquals(expected, actual);
    }

    /**
     * Verifies if a word was scrambled.
     */
    @Test
    public void test() {
